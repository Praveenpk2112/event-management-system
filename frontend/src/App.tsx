...
function Faculty() {
  ...
  async function handleRegister() {
    const res = await fetch('http://localhost:8086/faculty/register', {
      method: 'POST',
  ...
  async function handleLogin() {
    const res = await fetch('http://localhost:8086/faculty/login', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  async function fetchEvents() {
    const res = await fetch('http://localhost:8084/events/all')
  ...
  async function handlePostEvent() {
    ...
    const res = await fetch('http://localhost:8086/faculty/events/post', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  async function handleDelete(stuRno: string) {
    await fetch(`http://localhost:8084/faculty/delete/${stuRno}`, { method: 'DELETE' })
...
function Register() {
  ...
  async function handleRegister() {
    const res = await fetch('http://localhost:8085/register/user', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
